...
<Image src="/images/blog/thumbnail-maker/thumbnail-maker-main.png" width="1920" height="1080" alt="썸네일메이커 메인화면" class="mt-8 border" />

컨셉은 아주 단순합니다. 메인 페이지에 진입하면, default로 정의된 값들로 썸네일을 생성하고, 이를 preview로 보여줍니다.
...
```
`@vercel/og`는 Next.js 13의 App Router를 사용한다면 따로 설치하지 않아도 사용이 가능합니다. HTML태그와 Tailwind CSS를 이용해 썸네일을 디자인하고
이를 ImageResponse로 리턴하는 방식입니다.
